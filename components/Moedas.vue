<template>
    <div class="bg-indigo-200">
        ...
        <div class="bg-blue-600  lg:h-screen lg:justify-center lg:min-h-screen lg:flex lg:items-center p-8 sm:p-12">
            <div class="flex-grow">
                <h1 class="text-white text-center text-2xl sm:text-5xl mb-2 self-auto">Moedas</h1><br>
                <p class="text-center text-lg text-blue-200">Pesquise uma moeda pela sua sigla!</p><br>
                <div class="items-center flex ">
                    <input class="flex-1 w-full mr-2 text-gray-700 px-4 py-1 bg-gray-300 rounded-md hover:bg-gray-200 focus:bg-white focus:outline-none border border-gray-300" type="text" placeholder="ID da Moeda" name="author" v-model="name">
        ...
        <div class="sm:min-h-screen flex items-center p-3 lg:p-24 xl:p-48 h-screen justify-center items-center">
            <div class="overscroll-auto overflow-y-scroll p-1  h-full ">
                <div class="bg-white shadow-xl rounded-md border border-gray-300 p-2" v-for="(comment, index) in listaDeMoedas" v-bind:key="index">
                    <div class="">
...
<script>
let apikey = "9F6E1E03-4C3B-4854-8F1E-63E24538A0A0"
export default{
    ...
    mounted(element,operador) {
     ...
     carregarValores(){
                    if (this.verificar_erro === 0){
                        ...
                        setTimeout(() => { this.verificar_erro= 0,
